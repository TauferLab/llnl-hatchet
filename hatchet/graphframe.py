...
class GraphFrame:
    ...
    @staticmethod
    @annotate("GraphFrame.from_hpctoolkit")
    ...
    @staticmethod
    @annotate("GraphFrame.from_hpctoolkit_latest")
    ...
    @staticmethod
    @annotate("GraphFrame.from_caliper")
    ...
    @staticmethod
    @annotate("GraphFrame.from_caliperreader")
    ...
    @staticmethod
    @annotate("GraphFrame.from_timeseries")
    def from_timeseries(
    ...
    @staticmethod
    @annotate("GraphFrame.from_spotdb")
    ...
    @staticmethod
    @annotate("GraphFrame.from_gprof_dot")
    ...
    @staticmethod
    @annotate("GraphFrame.from_cprofile")
    ...
    @staticmethod
    @annotate("GraphFrame.from_pyinstrument")
    ...
    @staticmethod
    @annotate("GraphFrame.from_timeory")
    ...
    @staticmethod
    @annotate("GraphFrame.from_literal")
    ...
    @staticmethod
    @annotate("GraphFrame.from_lists")
    ...
    @annotate("GraphFrame.drop_index_levels")
    ...
    @annotate("GraphFrame.subtree_sum")
    def subtree_sum(
    ...
    @annotate("GraphFrame.subgraph_sum")
    def subgraph_sum(
        self, columns, out_columns=None, function=lambda x: x.sum(min_count=1)
    ):
    ...
    @annotate("GraphFrame.generate_exclusive_columns")
    ...
    @annotate("GraphFrame.update_inclusive_columns")
    ...
    @annotate("GraphFrame.to_flamegraph")
    ...
    @annotate("GraphFrame.to_literal")
    ...
    @annotate("GraphFrame.groupby_aggregate")
    ...
    @annotate("GraphFrame.__truediv__")
